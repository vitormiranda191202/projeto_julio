                ...
                def salvar_edicao():
                    try:
                        with SessionLocal() as db:
                            ...
                            # --- Ajustar estoque e movimentações ---
                            # 1. Criar dicionário de itens antigos por cor
                            estoque_antigo = {}
                            ...
                            # 3. Ajustar estoque com base na diferença
                            for novo in novos_itens:
                                ...
                                if not estoque:
                                    ...
                                    if estoque.qt_rolos < dif_qt:
                                        messagebox.showerror("Erro", f"Estoque insuficiente para a cor {cor}. Disponível: {estoque.qt_rolos}")
                                        return
